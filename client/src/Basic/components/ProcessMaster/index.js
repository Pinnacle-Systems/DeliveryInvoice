...
import { useAddprocessMasterMutation, useDeleteprocessMasterMutation, useGetprocessMasterByIdQuery, useGetprocessMasteresQuery, useUpdateprocessMasterMutation } from '../../../redux/services/ProcessMasterService';
...
export default function Form() {
  ...
  const { data: allData, isLoading, isFetching } = useGetprocessMasteresQuery({ params, searchParams: searchValue });
  const { data: singleData, isFetching: isSingleFetching, isLoading: isSingleLoading } = useGetprocessMasterByIdQuery(id, { skip: !id });

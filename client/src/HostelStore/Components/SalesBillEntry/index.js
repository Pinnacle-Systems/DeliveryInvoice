...
import { findFromList, getDateFromDateTime, isGridDatasValid } from '../../../Utils/helper';
  ...
  return (
    ...
    <div onKeyDown={handleKeyDown} className='md:items-start md:justify-items-center grid h-full bg-theme'>
      ...
      <Modal
            ...
            >
          <PrintReportOpen onClick={(value) => { setPrintReportOpen(false);openPrint(value) }} />
          </Modal>
            ...
            <div className='mr-1 md:ml-2'>
              ...
              <div className="hidden">
                <RetailPrintFormatFinishedGoodsSales
                  innerRef={componentRef}  contactMobile={contactMobile} name={name} date={id ? singleData?.data?.createdAt :date} id={id} poBillItems={poBillItems} readOnly={readOnly} docId={docId ? docId : ''} />
              </div>
            </div>
          </div>

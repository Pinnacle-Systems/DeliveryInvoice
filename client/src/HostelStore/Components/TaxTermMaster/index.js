...
import { useAddTaxTermMasterMutation, useDeleteTaxTermMasterMutation, useGetTaxTermMasterByIdQuery, useGetTaxTermMasterQuery, useUpdateTaxTermMasterMutation } from "../../../redux/services/TaxTermMasterServices";
                                            ...
                                            <div className="space-y-4 ">
                                                <fieldset className=' rounded mt-2'>
                                                    <div className='grid grid-cols-2 my-2'>
                                                        ...
                                                        <TextInputNew name="Name" type="text" value={name} setValue={setName} required={true} readOnly={readOnly} disabled={(childRecord.current > 0)} />
                                                        </div>
                                                        {/* <CheckBox name="Po wise" readOnly={readOnly} value={isPoWise} setValue={setIsPowise} /> */}
                                                    </div>
